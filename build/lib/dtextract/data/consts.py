...
DIABETES_HEADERS = ["encounter_id", "patient_nbr", "race", "gender", "age", "weight", "admission_type_id", "discharge_disposition_id",
...
CONFLICTS_HEADERS = ["path_similarity", "qos", "time", "negation", "synonyms", "hierarchy_targets",
                     "hierarchy_traffics", "endpoints", "num_endpoints", "services",
                     "num_services", "groups", "num_groups", "traffics", "num_traffics",
                     "protocols", "num_protocols", "middleboxes", "num_middleboxes", "conflict"]
...
CONFLICTS_OUTPUT = LOG_PATH + 'conflicts.log'
...
STUDENT_HEADERS = ["id", "school", "sex", "age", "address", "famsize", "Pstatus", "Medu", "Fedu", "Mjob", "Fjob", "reason",
                   "nursery", "internet", "guardian.x", "traveltime.x", "studytime.x", "failures.x", "schoolsup.x", "famsup.x",
                   "paid.x", "activities.x", "higher.x", "romantic.x", "famrel.x", "freetime.x", "goout.x", "Dalc.x", "Walc.x",
                   "health.x", "absences.x", "G1.x", "G2.x", "G3.x", "guardian.y", "traveltime.y", "studytime.y", "failures.y",
                   "schoolsup.y", "famsup.y", "paid.y", "activities.y", "higher.y", "romantic.y", "famrel.y", "freetime.y", "goout.y",
                   "Dalc.y", "Walc.y", "health.y", "absences.y", "y"]
